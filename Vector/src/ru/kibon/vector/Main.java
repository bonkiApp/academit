...
public class Main {
    public static void main(String[] args) {
        ...
        int component = 3;
        System.out.printf("Компонента вектора под индексом %s равна: %s%n", component, vector2.getComponent(component));

        int value = 4;
        vector2.setComponent(component, value);
        System.out.printf("Установка значения компонента под индексом %s равным %s: %s%n", component, value, vector2.toString(vector2));
